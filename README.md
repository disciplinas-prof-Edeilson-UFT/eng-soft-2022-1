...
5. Então ele será redirecionado a uma página web onde ele poderá ler um artigo sobre como a Uber usa as informações de localização do usuàrio de android;
